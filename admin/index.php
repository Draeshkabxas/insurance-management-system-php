                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-5 mb-3">
                                <div class="card">
                                    ...
                                    <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-bar-chart-alt"></i> التخصصات</div>
                            ...
                            <div class="col-md-4 mt-md-5 mb-3">
                                <div class="card">
                                    ...
                                    <a href="subcategory.php">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-bar-chart-alt"></i> الاقسام</div>
                            ...
                            <div class="col-md-4 mt-5 mb-3">
                                <div class="card">
                                    ...
                                    <a href="policy.php">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-bar-chart-alt"></i> الاطباء</div>
                            ...
                            <div class="col-md-4  mb-3">
                                <div class="card">
                                    ...
                                    <a href="users.php">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-bar-chart-alt"></i> المرضى</div>
                            ...
                            <div class="col-md-4  mb-3">
                                <div class="card">
                                    ...
                                    <a href="pendingpolicy.php">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-bar-chart-alt"></i> المواعيد المعلقة</div>
                            ...
                            <div class="col-md-4  mb-3">
                                <div class="card">
                                    ...
                                    <a href="approvedpolicy.php">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-bar-chart-alt"></i>المواعيد المعتمدة</div>
                            ...
                            <div class="col-md-4  mb-3">
                                <div class="card">
                                    ...
                                    <a href="rejectedpolicy.php">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-bar-chart-alt"></i>المواعيد المرفوضة</div>
